...
import com.murong.data.GlobalStatus
import com.murong.data.IEventReceiver
import com.murong.library.basic.InputMethodApp
import com.murong.library.basic.LauncherApps
import com.murong.library.calculator.Flags
import com.murong.scene_mode.AppSwitchHandler
import com.murong.scene_mode.AutoClickInstall
import com.murong.scene_mode.AutoSkipAd
import com.murong.store.SpfConfig
import com.murong.utils.AutoSkipCloudData
import com.murong.diaodu.popup.FloatLogView
...
public class AccessibilityScenceMode : AccessibilityService(), IEventReceiver {
    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent) {
        ...
        */
        ...
        if (packageName != null) {
            when {
                packageName == "com.murong.gesture" || packageName == "com.murong.filter" -> {
                    return
                }
                /*
                ...
                */
                // packageName == "com.murong.diaodu" -> return
        ...
        if (effectiveWindows.isNotEmpty()) {
            try {
                ...
                for (window in effectiveWindows) {
                    ...
                    if (wp == null || wp == "android" || wp == "com.android.systemui" || wp == "com.miui.freeform" || wp == "com.murong.gesture" || wp == "com.murong.filter" || wp == "com.android.permissioncontroller") {
                        continue
                    }
                    */

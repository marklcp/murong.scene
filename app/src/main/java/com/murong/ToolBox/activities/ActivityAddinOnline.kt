...
class ActivityAddinOnline : ActivityBase() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (url != null) {
            if (url.startsWith("https://vtools.oss-cn-beijing.aliyuncs.com/") || url.startsWith("http://www.coolapk.com/u/5037694/")) {
                // 添加kr-script for web

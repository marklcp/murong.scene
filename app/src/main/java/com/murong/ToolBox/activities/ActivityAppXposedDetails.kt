...
import com.murong.store.XposedExtension
import com.murong.ui.IntInputFilter
import com.murong.vaddin.IAppConfigAidlInterface
...
class ActivityAppXposedDetails : ActivityBase() {
    ...
    fun getAddinVersion(): Int {
        ...
        try {
            ...
            val info = manager.getPackageInfo("com.murong.vaddin", 0)
    ...
    private fun bindService() {
        ...
        try {
            val intent = Intent();
            //绑定服务端的service
            intent.setAction("com.murong.vaddin.ConfigUpdateService");
            //新版本（5.0后）必须显式intent启动 绑定服务
            intent.setComponent(ComponentName("com.murong.vaddin", "com.murong.vaddin.ConfigUpdateService"));
            //绑定的时候服务端自动创建
    ...
    private fun checkXposedState() {
        ...
        try {
            vAddinsInstalled = packageManager.getPackageInfo("com.murong.vaddin", 0) != null

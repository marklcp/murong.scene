...
import com.murong.common.model.SelectItem
import com.murong.common.shell.KeepShellPublic
import com.murong.common.shell.ShellTranslation
import com.murong.common.ui.DialogHelper
import com.murong.common.ui.DialogItemChooser
import com.murong.data.GlobalStatus
import com.murong.library.device.GpuInfo
import com.murong.library.shell.*
import com.murong.model.CpuCoreInfo
import com.murong.model.ProcessInfo
import com.murong.store.SpfConfig
import com.murong.ui.AdapterCpuCores
import com.murong.ui.AdapterProcessMini
import com.murong.diaodu.R
import com.murong.diaodu.activities.*
import com.murong.diaodu.dialogs.DialogElectricityUnit
...
class FragmentHome : androidx.fragment.app.Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        home_help.setOnClickListener {
            try {
                startActivity(
                    Intent(Intent.ACTION_VIEW, Uri.parse("http://www.coolapk.com/u/5037694/"))
                )
            } catch (ex: Exception) {

package com.murong.diaodu.services
        ...
        if (compile_method == "reset") {
            ...
            for (packageName in packageNames) {
                if (true) {
                    ...
                    cmdBuilder.append("am broadcast -n com.murong.diaodu/com.murong.diaodu.ReceiverCompileState --ei current $current --ei total $total --es packageName $packageName\n")
            ...
            cmdBuilder.append("am broadcast -n com.murong.diaodu/com.murong.diaodu.ReceiverCompileState --ei current $total --ei total $total --es packageName OK\n")

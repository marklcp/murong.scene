...
public class KrScriptConfig2 {
    ...
    private final static String EXECUTOR_CORE = "Home";
    private final static String PAGE_LIST_CONFIG = "Page_config";
    private final static String PAGE_LIST_CONFIG_SH = "Page_config_sh";
    ...
    public PageNode getPage_configConfig() {
        if (configInfo != null) {
            PageNode pageInfo = new PageNode("");

...
import com.murong.store.AutoSkipConfigStore
...
class AutoSkipAd(private val service: AccessibilityService) {
    ...
    private val blackList = arrayListOf("android", "com.android.systemui", "com.miui.home", "com.tencent.mobileqq", "com.tencent.mm", "com.murong.diaodu", "com.murong.gesture", "com.android.settings")

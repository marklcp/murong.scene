...
import com.murong.library.shell.LocationHelper
...
class SystemScene(private var context: Context) {
    ...
    private fun switchLowPowerModeShell(powersave: Boolean) {
        ...
        if (lowPowerModeShell!!.isEmpty()) {
            lowPowerModeShell = com.murong.common.shared.FileWrite.writePrivateShellFile("addin/power_save_set.sh", "addin/power_save_set.sh", context)
        }

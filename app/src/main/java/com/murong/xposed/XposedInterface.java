...
import com.murong.xposed.wx.WeChatScanHook;
...
public class XposedInterface implements IXposedHookLoadPackage, IXposedHookZygoteInit {
    ...
    public void initZygote(IXposedHookZygoteInit.StartupParam startupParam) throws Throwable {
        prefs = new XSharedPreferences("com.murong.vaddin", "xposed");
    ...
    public void handleLoadPackage(final XC_LoadPackage.LoadPackageParam loadPackageParam) throws Throwable {
        ...
        switch (packageName) {
            // 用于检查xposed是否激活
            case "com.murong.diaodu":
            case "com.murong.vboot":
